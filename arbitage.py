...
# def fetch_market_cap(pair):
#     """Fetch the market capitalization of the trading pair."""
#     ticker = bitrue.fetch_ticker(pair)
#     market_cap = Decimal(str(ticker["quoteVolume"])) * Decimal(str(ticker["last"]))
#     print(f"Market Cap for {pair}: {market_cap}")
#     return market_cap
...
#     # Fetch market cap
#     market_cap = fetch_market_cap(PAIR_USDT)
