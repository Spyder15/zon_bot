...
HIGH_PRICE_THRESHOLD = Decimal("0.008")
RETRY_DELAY = 5  # Delay in seconds between cycles                
RESERVE_THRESHOLD = Decimal("3.00")  # Reserve USDT threshold                                 
MAX_TRADE_AMOUNT = Decimal("50.00")  # Max trade size in USDT
TRADE_LIMIT = Decimal("50.00")  # Max trade size in USDT or ZON
...
def execute_cycle(cycle, current_price, usdt_balance):
    ...
    if sell_wall_price:
        ...
        first_sell_amount = TRADE_LIMIT / first_sell_price
